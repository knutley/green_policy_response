...
## ParlSpeech Data from: https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/L4OAKN&version=1.0
...
df <- readRDS("~/Downloads/Corp_HouseOfCommons_V2.rds")
...
saveRDS(filtered_df, "filtered_UK.rds")
